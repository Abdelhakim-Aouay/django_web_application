...
class Band(models.Model):
    ...
    official_homepage=models.fields.URLField(null=0, blank=True)
...
class Listing(models.Model): 
    ...
    year=models.fields.IntegerField(null=1, validators=[MinValueValidator(1900), MaxValueValidator(2022)])
    desccription=models.fields.CharField(max_length=100)
